...
namespace AssetTracking_EF
{
    class Program
    {
        ...
        //private static IEnumerable<CompanyAsset> assets;
        ...
        static void WriteItemToConsole(CompanyAsset item)
        {
            Console.WriteLine(item.AssetType.PadRight(10) + "  " + item.ModelName.PadRight(10) + item.Price.ToString().PadLeft(7) + "  " + item.PurchaseDate.ToString("MM/dd/yyyy").PadRight(10) + "   " + item.Office.PadRight(10));
        }
